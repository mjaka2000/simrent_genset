...
{
    protected $_ci;
    protected $email_pengirim = 'jakpertra12@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Jaka'; // Isikan dengan nama pengirim
    protected $password = 'nwkwwwiqwjvwkqfo'; // Isikan dengan password email pengirim
