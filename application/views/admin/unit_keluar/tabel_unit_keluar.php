                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($list_data as $dt) : ?>
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td>
                                                <a href="<?= site_url('admin/hapus_unit_keluar/' . $dt->id_u_sewa); ?>" type="button" title="Hapus" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash "></i></a>
                                                ...
                                                <!-- <a href="<?= site_url('admin/detail_unit_keluar/' . $dt->id_u_sewa); ?>" type="button" title="Lihat Detail" class="btn btn-sm btn-warning" name="btn_detail"><i class="fa fa-info-circle "></i></a> -->
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h6 class="modal-title" id="staticBackdropLabel">Tambah Data Genset Disewa</h6>
