...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Acc Pengajuan</li>
        </ol>
        <!-- /.container-fluid -->
    </section>
                ...
                <div class="container">
                    <div class="box box-primary" style="width:50%;margin:auto">
                        <div class="box-header">
                            <h3 class="box-title"><i class="nav-icon fa fa-edit mr-2"></i>Acc Pengajuan</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <form action="<?= base_url('admin/proses_update_baru'); ?>" method="post" role="form">
