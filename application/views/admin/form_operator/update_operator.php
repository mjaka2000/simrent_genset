                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= site_url('admin/proses_update_operator'); ?>" method="post" role="form">
                                ...
                                <div class="form-group" align="center">
                                    <button onclick="window.location.href='<?= site_url('admin/tabel_operator'); ?>'" type="button" class="btn btn-sm btn-default" name="btn_kembali"><i class="fa fa-arrow-left mr-2"></i>Kembali</button>
