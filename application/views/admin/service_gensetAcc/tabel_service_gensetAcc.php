                                        ...
                                        <?php foreach ($list_data as $d) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- <a href="<?= base_url('admin/update_service_genset_acc/' . $d->id_serv_gst_acc); ?>" type="button" title="Edit" class="btn btn-sm btn-info" name="btn_edit"><i class="fa fa-edit"></i></a> -->
                                                    <a href="<?= base_url('admin/hapus_service_genset_acc/' . $d->id_serv_gst_acc); ?>" type="button" title="Hapus" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash"></i></a>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="<?= site_url('admin/proses_tambah_ServGstAcc'); ?>" method="post" role="form">
