                                    ...
                                    <?php foreach ($list_data as $d) : ?>
                                        <tr>
                                            ...
                                            <?php if ($d->status_jdw == "0") { ?>
                                                <td>
                                                    <button type="button" class="btn btn-success btn-xs dropdown-toggle" title="Ubah Status" data-toggle="dropdown">Tidak Dijadwalkan</button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item disabled" href="#">Tidak Dijadwalkan</a>
                                                        <a class="dropdown-item" href="<?= site_url('admin/ubah_status_jdw/' . $d->id_jadwal_genset); ?>">Dijadwalkan</a>
                                                    </div>
                                                </td>
                                                <!-- <a href="#" type="button" class="btn btn-xs btn-success">Tidak Dijadwalkan</a></td> -->
                                            <?php } else { ?>
                                                <td>
                                                    <button type="button" class="btn btn-warning btn-xs dropdown-toggle" title="Ubah Status" data-toggle="dropdown">Dijadwalkan</button>
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item " href="<?= site_url('admin/ubah_status_Notjdw/' . $d->id_jadwal_genset); ?>">Tidak Dijadwalkan</a>
                                                        <a class="dropdown-item disabled" href="#">Dijadwalkan</a>
                                                    </div>
                                                </td>
