            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Update Data Stok Sparepart</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card" style="width: 30%; margin-left: 35%;">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/proses_update_sparepart'); ?>" method="post" role="form">
