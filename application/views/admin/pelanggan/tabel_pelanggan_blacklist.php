                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <button style="margin-bottom:10px;" onclick="window.location.href='<?= site_url('admin/tabel_pelanggan'); ?>'" type="button" class="btn btn-sm btn-default" name="blacklist_data"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</button>
                                        ...
                                        <?php foreach ($list_pelanggan_blacklist as $dt) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= site_url('admin/kembalikan_pelanggan/' . $dt->id_pelanggan); ?>" title="Kembalikan Status Pelanggan" type="button" class="btn btn-sm btn-warning btn-plg" name="btn_delete"><i class="fa fa-history"></i></a>
