               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item ">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url(); ?>admin/tabel_mobil" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Mobil</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url(); ?>admin/tabel_operator" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Operator</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url(); ?>admin/tabel_pelanggan" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Pelanggan</p>
                            </a>
                        </li>
                ...
                <li class="nav-item ">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url(); ?>admin/tabel_unit_keluar" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Unit Keluar</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url(); ?>admin/tabel_unit_masuk" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Unit Masuk</p>
                            </a>
                        </li>
