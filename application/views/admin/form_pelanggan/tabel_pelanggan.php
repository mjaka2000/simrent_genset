                                    ...
                                    if (is_array($list_pelanggan)) { ?>
                                        <?php foreach ($list_pelanggan as $dt) : ?>
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <td><a href="<?= site_url('admin/update_data_pelanggan/' . $dt->id_pelanggan); ?>" type="button" class="btn btn-sm btn-info" name="btn_edit"><i class="fa fa-edit "></i></a>
                                                    <a href="<?= site_url('admin/hapus_pelanggan/' . $dt->id_pelanggan); ?>" type="button" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash "></i></a>
