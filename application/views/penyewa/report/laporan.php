                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="reporttable" class="table table-bordered" style="width:100%">
                                ...
                                <tr>
                                    <form action="<?= site_url(); ?>report/cetak_cetak_penyewaan_usr" method="post" role="form" target="_blank">
                                        <th style="vertical-align: middle">Laporan Data Penyewaan</th>
                                ...
                                <!-- <tr>
                                    <form action="<?= site_url(); ?>penyewa/#" method="post" role="form" target="_blank">
