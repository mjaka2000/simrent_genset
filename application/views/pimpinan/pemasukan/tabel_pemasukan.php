                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- <button onclick="window.location.href='<?= site_url('pimpinan/tambah_pemasukan'); ?>'" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-primary" name="tambah_data"><i class="fa fa-plus"></i>&nbsp;Tambah Data</button> -->
                                    ...
                                    <?php foreach ($list_data as $d) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <a href="<?= site_url('pimpinan/edit_pemasukan/' . $d->id_pendapatan); ?>" type="button" title="Edit" class="btn btn-sm btn-info" name="btn_edit"><i class="fa fa-edit "></i></a> -->
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?= site_url('pimpinan/tabel_pemasukan'); ?>" method="get" role="form">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="<?= site_url('pimpinan/proses_tambah_pemasukan'); ?>" method="post" role="form">
