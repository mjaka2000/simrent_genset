...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Detail Data Genset Masuk</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('guest') ?>">Home</a></li>
            <li class="breadcrumb-item"><a href="<?= base_url('guest/tabel_barang_masuk'); ?>"> Data Genset Masuk</a></li>
            <li class="breadcrumb-item active">Detail Data Genset Masuk</li>
        </ol>
        <!-- /.container-fluid -->
    </section>
                ...
                <div class="container">
                    <div class="box box-primary" style="width:50%;margin:auto">
                        <div class="box-header">
                            <h3 class="box-title"><i class="nav-icon fa fa-info-circle mr-2"></i>Detail Data Genset Masuk</h3>
                        </div>
                        <div class="box-body">
                        ...
                        <div class="box-footer" align="center">
                            <a href="<?= base_url('guest/tabel_barang_masuk'); ?>" type="button" class="btn btn-sm btn-default" name="btn_kembali"><i class="fa fa-arrow-left mr-2"></i>Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
