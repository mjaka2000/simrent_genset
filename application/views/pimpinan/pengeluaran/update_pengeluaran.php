            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('pimpinan/tabel_pengeluaran'); ?>">Pengeluaran</a></li>
                ...
                <div class="col-md-5 ">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= site_url('pimpinan/proses_edit_pengeluaran'); ?>" method="post" role="form">
