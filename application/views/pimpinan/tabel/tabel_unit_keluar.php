                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($list_data as $dt) : ?>
                                        <tr>
                                            ...
                                            <?php if ($dt->status == 1) { ?>
                                                <td>
                                                    <a href="<?= base_url('pimpinan/unit_keluar_update/' . $dt->id_u_keluar); ?>" type="button" class="btn btn-xs bg-fuchsia btn-unitpanjang" name="btn_barangmasuk"><i class="fa fa-edit mr-2"></i>Perpanjang</a><br>
