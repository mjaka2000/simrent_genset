                        ...
                        <div class="card-body card-primary card-outline" align="center">
                            <div class="info">
                                <?php foreach ($avatar as $a) { ?>
                                    ...
                                    <strong><?= $this->session->userdata('name') ?></strong> sebagai Pimpinan
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-three-tabContent">
                                    <div class="tab-pane fade" id="picture" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                        <form class="form-horizontal" action="<?= site_url('pimpinan/proses_gambarupload'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane fade" id="backupdb" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                        <button onclick="window.location.href='<?= site_url('pimpinan/backup_db'); ?>'" class="btn btn-sm btn-primary"><i class="fa fa-database"></i>&nbsp;Backup DB</button>
                                    </div>
                                    ...
                                    <div class="tab-pane fade show active" id="settings" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                        ...
                                        <?php } ?>
                                        <form class="form-horizontal" action="<?= site_url('pimpinan/proses_newpassword'); ?>" method="post">
                                            <div class="form-group row">
