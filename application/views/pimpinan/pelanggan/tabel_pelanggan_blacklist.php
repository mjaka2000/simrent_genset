                                    ...
                                    if (is_array($list_pelanggan_blacklist)) { ?>
                                        <?php foreach ($list_pelanggan_blacklist as $dt) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a href="<?= site_url('pimpinan/update_data_pelanggan/' . $dt->id_plg_blacklist); ?>" type="button" class="btn btn-sm btn-info" name="btn_edit"><i class="fa fa-edit "></i></a> -->
                                                    <!-- <a href="<?= site_url('pimpinan/kembalikan_pelanggan/' . $dt->id_plg_blacklist); ?>" type="button" class="btn btn-sm btn-warning" name="btn_delete"><i class="fa fa-history"></i></a> -->
                                                    <a href="<?= site_url('pimpinan/hapus_pelanggan_blacklist/' . $dt->id_plg_blacklist); ?>" type="button" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash "></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php } ?>
