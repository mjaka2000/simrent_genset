            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('pimpinan/service_genset_acc'); ?>">Perbaikan Genset Disetujui</a></li>
                            ...
                            <?php foreach ($list_data as $d) { ?>
                                <form action="<?= site_url('pimpinan/proses_ubah_ServGstAcc'); ?>" method="post" role="form">
                                    ...
                                    <div class="form-group">
                                        <label for="nama" class="form-label">Perbaikan Genset Selesai<span><small style="color: red;">*Pilih untuk menampilkan isi field</small></span></label>
