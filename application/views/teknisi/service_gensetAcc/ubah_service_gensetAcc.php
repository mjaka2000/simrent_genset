            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('teknisi/service_genset_acc'); ?>">Perbaikan Genset Disetujui</a></li>
                ...
                <div class="col-md-5 ">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= site_url('teknisi/proses_ubah_ServGstAcc'); ?>" method="post" role="form">
...
<script type="text/javascript">
    ...
    $("#id_perbaikan_gst").show(function() {
        let kode_genset = $(this).val();
        <?php foreach ($list_perbaikan as $l) { ?>
            if (kode_genset == "<?php echo $l->id_perbaikan_gst ?>") {
                $("#nama_genset").val("<?php echo $l->nama_genset ?>");
