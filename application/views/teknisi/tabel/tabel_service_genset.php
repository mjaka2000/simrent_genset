                                        ...
                                        <?php foreach ($list_data as $dt) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url('teknisi/hapus_service_genset/' . $dt->id_perbaikan_gst); ?>" type="button" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash"></i></a>
                                                    <a href="<?= base_url('teknisi/detail_service_genset/' . $dt->id_perbaikan_gst); ?>" type="button" class="btn btn-sm btn-warning" name="btn_detail"><i class="fa fa-info-circle "></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php } ?>
...
<script>
    ...
    //         "url": '<?= site_url('teknisi/ajax_list_serv'); ?>',
    //         "type": "POST"
    //     }
    // });
</script>
