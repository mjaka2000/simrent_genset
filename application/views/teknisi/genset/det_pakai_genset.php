            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('teknisi/tabel_genset'); ?>">Genset</a></li>
                ...
                <div class="col-md-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <button onclick="window.location.href='<?= site_url('teknisi/tabel_genset'); ?>'" type="button" class="btn btn-sm btn-default" name="btn_kembali" style="margin-bottom:10px;"><i class="fa fa-arrow-left mr-2"></i>Kembali</button>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?php foreach ($list_data as $d) : ?>
                                        <form action="<?= site_url('teknisi/detail_genset/' . $d->id_genset); ?>" method="get" role="form">
